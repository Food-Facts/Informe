...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>Ernesto Casaverde <br> TB1: Brindó ideas clave para la creación del proyecto y el landing page.<br> TP1: Proporcionó sugerencias y recomendaciones para la creación y presentación del front-end.<br> TB2: Participó en la creación y presentación del backend, ofreciendo ideas y soluciones.<br> TF1: Ayudó en el despliegue y finalización del backend, comunicando sus avances y dudas.<br><br>Abraham Acosta<br> TB1: Participó en la lluvia de ideas y brindó información adicional para la creación del proyecto.<br> TP1: Ayudó en la creación y presentación del front-end, ofreciendo su tiempo y conocimientos.<br> TB2: Colaboró en la creación y presentación del backend, comunicando sus avances y dudas.<br> TF1: Participó en el despliegue y finalización del backend, asegurando una comunicación efectiva.<br><br>Michael Quispe<br> TB1: Coordinó reuniones y facilitó la comunicación dentro del equipo durante la creación del proyecto.<br> TP1: Ayudó en la creación y presentación del front-end, asegurando una comunicación clara y efectiva.<br> TB2: Supervisó la creación y presentación del backend, manteniendo una comunicación constante.<br> TF1: Coordinó el despliegue y finalización del backend, liderando el equipo para cumplir con los objetivos.<br><br>Sebastian Ramos<br> TB1: Se comunicó por el grupo para brindar ayuda y apoyó en la lluvia de ideas durante la creación del proyecto.<br> TP1: Ayudó en la creación y presentación del front-end, apoyando al grupo y comunicando sus avances.<br> TB2: Participó en la creación y presentación del backend, comunicando sus avances y dudas.<br> TF1: Ayudó en el despliegue y finalización del backend, asegurando una comunicación efectiva.<br><br>Melina Santillan<br> TB1: Se comunicaba frecuentemente y expresaba sus dudas durante la creación del proyecto.<br> TP1: Brindó ayuda a los compañeros y comunicó sus dudas durante la creación y presentación del front-end.<br> TB2: Participó en la creación y presentación del backend, comunicando sus avances y dudas.<br> TF1: Ayudó en el despliegue y finalización del backend, asegurando una comunicación efectiva.</td>
            <td>El equipo demostró una comunicación constante y efectiva, donde cada miembro aportó ideas y apoyó en la coordinación del trabajo.<br>Ernesto Casaverde brindó ideas clave para el desarrollo del proyecto y las historias de usuario, además de dar recomendaciones para mejorar el trabajo en general.<br>Abraham Acosta y Sebastián Ramos apoyaron en la lluvia de ideas y la comunicación de avances.<br>Michael Quispe coordinó las reuniones y facilitó la comunicación dentro del equipo, asegurando la colaboración fluida.<br>Melina Santillán mantuvo una comunicación continua, expresando sus dudas y asegurándose de estar al tanto del progreso del equipo.<br>Esta dinámica de interacción contribuyó al éxito y avance del proyecto.</td>
        </tr>
        <tr>
            <td>Comunica por escrito con efectividad a diferentes <br> rangos de audiencia.</td>
            <td>Ernesto Casaverde <br> TB1: Creó el repositorio y el informe, y realizó partes clave del capítulo IV y V durante la creación del proyecto.<br> TP1: Creó el repositorio del front-end y realizó partes del mismo de manera eficiente durante la creación y presentación del front-end.<br> TB2: Participó en la creación y presentación del backend, documentando sus avances y dudas.<br> TF1: Ayudó en el despliegue y finalización del backend, comunicando sus avances y dudas por escrito.<br><br>Abraham Acosta<br> TB1: Realizó los capítulos I, II y III, y ayudó en las mejoras continuas durante la creación del proyecto.<br> TP1: Comunicó por escrito sus inquietudes y realizó partes del front-end de manera eficiente durante la creación y presentación del front-end.<br> TB2: Colaboró en la creación y presentación del backend, documentando sus avances y dudas.<br> TF1: Participó en el despliegue y finalización del backend, asegurando una comunicación efectiva por escrito.<br><br>Michael Quispe<br> TB1: Realizó parte del capítulo IV y ayudó en la creación de las user stories y product backlog durante la creación del proyecto.<br> TP1: Comunicó los avances del front-end y realizó partes del mismo de manera eficiente durante la creación y presentación del front-end.<br> TB2: Supervisó la creación y presentación del backend, manteniendo una comunicación constante por escrito.<br> TF1: Coordinó el despliegue y finalización del backend, liderando el equipo para cumplir con los objetivos por escrito.<br><br>Sebastian Ramos<br> TB1: Realizó en su mayoría el landing page y fue realizando mejoras en el mismo durante la creación del proyecto.<br> TP1: Ayudó y comunicó los avances del front-end, respondiendo las dudas de los demás durante la creación y presentación del front-end.<br> TB2: Participó en la creación y presentación del backend, comunicando sus avances y dudas por escrito.<br> TF1: Ayudó en el despliegue y finalización del backend, asegurando una comunicación efectiva por escrito.<br><br>Melina Santillan<br> TB1: Realizó una parte del landing page y ayudó en las mejoras del mismo durante la creación del proyecto.<br> TP1: Avanzó parte del front-end y realizó partes del mismo de manera eficiente durante la creación y presentación del front-end.<br> TB2: Participó en la creación y presentación del backend, comunicando sus avances y dudas por escrito.<br> TF1: Ayudó en el despliegue y finalización del backend, asegurando una comunicación efectiva por escrito.</td>
...
Link de nuestro repositorio: https://github.com/Food-Facts 
...
| **Sprint 1 Review Summary** | Nos hemos reunido para analizar las User Stories y de acuerdo a ello poner en marcha el trabajo. Estamos neutros con el trabajo realizado. |
| **Sprint 1 Retrospective Summary** | Las opiniones son una buena comunicación y trabajo en equipo. |
| **Sprint Planning Background** | |
...
| **Prepared By** | Michael Quispe |
| **Attendees (to planning meeting)** | Ernesto Casaverde U20221B657 <br> Sebastian Ramos U202222846 <br> Abraam Acosta U202219199 <br> Melina Liz Santillan Alvarado U202216058 |
| **Sprint 2 Review Summary** | Nos hemos reunido para repartir el frontend, es decir que coordinamos quien iba realizar los puntos del frontend|
...
En este Aparto veremos colaboracion real entre todos los integrantes de FooDFacts en la implementacion del front end

Team collaboration de la Organizacion:

Todos hemos colaborado, sin embargo en la imagen se aprecia que Ernesto realizo los cambios ya que se encargo de organizar y hacer los commits de nuestras tareas.

<div style="text-align: center;">
    <img src="https://firebasestorage.googleapis.com/v0/b/imagenes-1f936.appspot.com/o/Imagenes_Open%2FCommits1.png?alt=media&token=57fc4064-5b5d-4d16-975c-990e5b099179" alt="W5" style="width: auto; height: auto;">
</div>
...
**URL:** https://upcedupe-my.sharepoint.com/:v:/g/personal/u202219199_upc_edu_pe/EYqykgJF8MlHhL9I3NIZE40ButtZK-gVUuE8DJigcGM3tQ?e=S505HL&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D
